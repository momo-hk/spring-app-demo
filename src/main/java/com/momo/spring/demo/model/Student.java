...
public class Student {
	...
	public String toString() {
		return String.format("Student: [Engname - %s, Chiname - %s, schLvl - %s, schSsn - %s, ClsLvl - %s, Clsname - %s, RegNum - %s, STRN - %s]", this.engName, this.chiName, this.schLvl, this.schScc, this.classLvl, this.classCode, this.regNum, this.strn);
	}
}
